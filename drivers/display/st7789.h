...
/**
 * @brief Initialize the ST7789 display and LVGL display driver.
 *
 * Configures SPI communication, initializes the ST7789 controller,
 * enables the display backlight, allocates LVGL frame buffers,
 * and registers the LVGL flush callback.
 */
